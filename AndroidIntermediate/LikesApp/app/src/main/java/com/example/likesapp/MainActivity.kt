...
//            showHair()
    ...
    private fun showTitid() {
        mPaint.color = ResourcesCompat.getColor(resources, R.color.yellow_left_skin, null)
        mCanvas.drawRect(halfOfWidth - 70F, halfOfHeight - 200F, halfOfWidth + 70F, halfOfHeight + 300F, mPaint)

        mPaint.color = ResourcesCompat.getColor(resources, R.color.yellow_right_skin, null)
        mCanvas.drawCircle(halfOfWidth - 80F, halfOfHeight + 300F, 100F, mPaint)
        mCanvas.drawCircle(halfOfWidth + 80F, halfOfHeight + 300F, 100F, mPaint)

        val kepala = RectF(left + 220F, top - 200F, right - 220F,  top + 300F)
        mPaint.color = ResourcesCompat.getColor(resources, R.color.yellow_right_skin, null)
        mCanvas.drawArc(kepala, 180F, 180F, false, mPaint)
    ...
    private fun showNose(){
        mPaint.color = ResourcesCompat.getColor(resources, R.color.black, null)
        mCanvas.drawCircle(halfOfWidth - 50F, halfOfHeight + 150F, 20F, mPaint)
        mCanvas.drawCircle(halfOfWidth + 50F, halfOfHeight + 150F, 20F, mPaint)
    }
