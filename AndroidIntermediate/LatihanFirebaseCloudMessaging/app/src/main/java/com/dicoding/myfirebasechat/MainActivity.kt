...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.sendButton.setOnClickListener {
            ...
            Log.d("BJIR", firebaseUser.displayName.toString())
            Log.d("BJIR", firebaseUser.photoUrl.toString())
            Log.d("BJIR", firebaseUser.email.toString())
            Log.d("BJIR", firebaseUser.uid)
            Log.d("BJIR", firebaseUser.isAnonymous.toString())
