...
public final class ActivityNewsDetailBinding implements ViewBinding {
  ...
  private ActivityNewsDetailBinding(@NonNull ConstraintLayout rootView, @NonNull WebView webView) {
  ...
  public static ActivityNewsDetailBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityNewsDetailBinding((ConstraintLayout) rootView, webView);
    }
