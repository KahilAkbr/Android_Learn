...
class DateFormatterTest{
    ...
    @Test
    fun `given incorrect ISO 8601 format then should throw exception`(){
        val wrongFormat = "2022-02-02 10:10:10Z"
    ...
    @Test
    fun `given invalid timezone then should throw exception`(){
